...
{{--                        </svg><span>Chat</span></a></li>--}}
                <li><a href="{{url('/dashboard/laporan/tampil')}}">
                        <svg class="bi bi-book" version="1.1" width="20" height="20" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
